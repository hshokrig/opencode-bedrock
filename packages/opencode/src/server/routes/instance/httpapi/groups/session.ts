    ...
    HttpApiGroup.make("session")
      .add(
        ...
        HttpApiEndpoint.post("shell", SessionPaths.shell, {
          ...
          success: described(SessionV1.WithParts, "Created message"),
          error: [HttpApiError.BadRequest, ApiNotFoundError, ServiceUnavailableError, SessionBusyError],
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.post("permissionRespond", SessionPaths.permissions, {
          ...
          error: [HttpApiError.BadRequest, ApiNotFoundError, PermissionNotFoundError, ServiceUnavailableError],
        }).annotateMerge(
          OpenApi.annotations({
