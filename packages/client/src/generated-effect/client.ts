...
type Endpoint3_0Input = {
  ...
  readonly purpose?: Endpoint3_0Request["query"]["purpose"]
...
type Endpoint3_1Input = {
  ...
  readonly purpose?: Endpoint3_1Request["payload"]["purpose"]
...
type Endpoint3_2Request = Parameters<RawClient["server.session"]["session.compareAndSetTitle"]>[0]
type Endpoint3_2Input = {
  readonly sessionID: Endpoint3_2Request["params"]["sessionID"]
  readonly expected: Endpoint3_2Request["payload"]["expected"]
  readonly title: Endpoint3_2Request["payload"]["title"]
}
const Endpoint3_2 = (raw: RawClient["server.session"]) => (input: Endpoint3_2Input) =>
  raw["session.compareAndSetTitle"]({
    params: { sessionID: input["sessionID"] },
    payload: { expected: input["expected"], title: input["title"] },
  }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint3_3Request = Parameters<RawClient["server.session"]["session.ensureTitle"]>[0]
type Endpoint3_3Input = {
  readonly sessionID: Endpoint3_3Request["params"]["sessionID"]
  readonly firstMessageID: Endpoint3_3Request["payload"]["firstMessageID"]
}
const Endpoint3_3 = (raw: RawClient["server.session"]) => (input: Endpoint3_3Input) =>
  raw["session.ensureTitle"]({
    params: { sessionID: input["sessionID"] },
    payload: { firstMessageID: input["firstMessageID"] },
  }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )
...
type Endpoint3_6Request = Parameters<RawClient["server.session"]["session.recovery"]>[0]
type Endpoint3_6Input = {
  readonly sessionID: Endpoint3_6Request["params"]["sessionID"]
  readonly messageID?: Endpoint3_6Request["query"]["messageID"]
}
const Endpoint3_6 = (raw: RawClient["server.session"]) => (input: Endpoint3_6Input) =>
  raw["session.recovery"]({ params: { sessionID: input["sessionID"] }, query: { messageID: input["messageID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )
...
const adaptGroup3 = (raw: RawClient["server.session"]) => ({
  ...
  compareAndSetTitle: Endpoint3_2(raw),
  ensureTitle: Endpoint3_3(raw),
  active: Endpoint3_4(raw),
  get: Endpoint3_5(raw),
  recovery: Endpoint3_6(raw),
